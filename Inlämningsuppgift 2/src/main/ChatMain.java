...
import chatcommunicator.UDPChatCommunicator;
...
public class ChatMain {
	...
	public static void main(String[] args) {
		...
		UDPChatCommunicator logic = new UDPChatCommunicator();

		// Add gui and logic as listerner to the two observers
		logic.addMessageListener(gui);
		gui.addMessageListener(logic);
